          ...
          clicked: function(e) {
            ...
            if (nearest && selected && nearest.node === selected.node) {
              ...
              if (link.match(/^#/)) {
                ...
                // console.log(selected.node._id);
                  // window.location.href = "index.php?name=" + selected.node._id; 
                                
                // $.post('rate.php', {variable: selected.node._id});

                // $.ajax({
                //   url: 'rate.php', //This is the current doc
                //   type: "POST",
